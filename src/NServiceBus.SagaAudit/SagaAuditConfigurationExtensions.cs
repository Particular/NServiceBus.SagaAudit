namespace NServiceBus
{
    ...
    public static class SagaAuditConfigurationExtensions
    {
        ...
        public static void AuditSagaStateChanges(this BusConfiguration config, string serviceControlQueue, Func<object, Dictionary<string, string>> customSagaEntitySerialization = null)
        {
            config.EnableFeature<SagaAuditFeature>();
            config.GetSettings().Set(SettingsKeys.SagaAuditQueue, Address.Parse(serviceControlQueue));
