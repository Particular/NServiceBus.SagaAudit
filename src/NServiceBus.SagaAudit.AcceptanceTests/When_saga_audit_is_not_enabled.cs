...
public class When_saga_audit_is_not_enabled : NServiceBusAcceptanceTest
{
    ...
    class EndpointWithASaga : EndpointConfigurationBuilder
    {
        ...
        {
            protected override void ConfigureHowToFindSaga(SagaPropertyMapper<TheEndpointsSagaData> mapper) => mapper.MapSaga(s => s.TestRunId).ToMessage<MessageToBeAudited>(msg => msg.Id);
